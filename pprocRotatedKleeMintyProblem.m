...
strategy = struct();
strategy.name = 'runepsMAgESOnRotatedKleeMintyProblem';
strategy.plottitle = '$\epsilon$MAg-ES';
strategy.path = ...
fullfile('.', ...
         [date '_linspaced_rotKM_RS_', ...
          strategy.name]);
...
strategy = struct();
strategy.name = 'runlcCMSAESOnRotatedKleeMintyProblem';
strategy.plottitle = 'lcCMSA-ES';
strategy.path = ...
fullfile('.', ...
         [date '_linspaced_rotKM_RS_', ...
          strategy.name]);
